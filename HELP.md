...
* The original package name 'com.ontony.trip-to' is invalid and this project uses 'com.ontony.tripto' instead.
...
```
$ docker run --rm -p 8080:8080 trip-to:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/trip-to
```
